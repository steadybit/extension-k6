...
| `$ make container` | Build the container image (`extension-k6:latest`) using Docker buildx.                                |
...
## Releasing Helm Chart Changes
 ...
 1. Update the version number in the [Chart.yaml](./charts/steadybit-extension-k6/Chart.yaml)
